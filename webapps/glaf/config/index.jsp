...
<title>数据源配置</title>
<link rel="stylesheet" type="text/css"	href="<%=request.getContextPath()%>/static/css/core.css" />
...
<div class="x_content_title"><img
	src="<%=request.getContextPath()%>/static/images/window.png"
	alt="数据源配置">&nbsp;数据源配置 
 </div>
...
<tr class="x-content-hight">
  ...
  <td> 
  <input id="password"
	name="password" type="password" size="25" class="x-text"
	maxlength="255" value=""> 
	</td>
 </tr>
...
<div align="center">
<br />
<input type="button" class="btnGray" value="重新配置"
	onclick="javascript:submitRequest(this.form, 'reconfig');" />
<input type="button" class="btnGray" value="测试连接"
