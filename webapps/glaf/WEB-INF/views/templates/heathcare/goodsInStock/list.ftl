   ...
   jQuery(function(){
		jQuery('#mydatagrid').datagrid({
				...
				columns:[[
					...
					{title:'单价', field:'price', width:90, align:'right'},
					{title:'总价', field:'totalPrice', width:90, align:'right'},
					{title:'入库日期', field:'inStockTime', width:100, align:'center'},
					{title:'有效期', field:'expiryDate', width:100, align:'center'},
      ...
      <table valign="middle">
       <tr>
	    <td valign="middle">
			...
			<!-- <button type="button" id="searchButton111" class="btn btnGrayMini" style="width: 60px" 
