...
<script type="text/javascript">
  ...
  jQuery(function() {
        ...
        "dataSource": {
            ...
            "transport": {
                ...
                "read": {
                    ...
                    "type": "POST",
                    "url": "${contextPath}/rs/heathcare/foodDRI/data?wordLike_base64=${wordLike_base64}&nodeId=${nodeId}"
                }
            },
    ...
    function addRow(){
         editRow('${contextPath}/heathcare/foodDRI/edit');
    }
	...
	function updateRow(){
        ...
        var link = "${contextPath}/heathcare/foodDRI/edit?id="+data.id;
	    editRow(link);
	}
    ...
    function searchData(){
		...
		var link="${contextPath}/heathcare/foodDRI/data?wordLike="+wordLike;
...
<br>
 <div class="x_content_title">
  <img src="${contextPath}/static/images/window.png" alt="膳食营养素参考摄入量标准列表">&nbsp;
    膳食营养素参考摄入量标准列表
 </div>
<form id="iForm" name="iForm" method="post" action="${contextPath}/heathcare/foodDRI">
<table>
<tr>
    <td>
	</td>
