...
<script type="text/javascript">
   ...
   jQuery(function(){
		jQuery('#mydatagrid').datagrid({
				...
				columns:[[
					...
					{title:'出库日期', field:'outStockTime', width:100, align:'center'},
   ...
   function editRow(id){
    ...
    function doExport() {
        ...
        var link = '${contextPath}/heathcare/reportMain/exportXls?startTime='+startTime+'&endTime='+endTime+'&reportId=GoodsOutStock';
		window.open(link);	
	}
