...
<script type="text/javascript">
   ...
   jQuery(function(){
		jQuery('#mydatagrid').datagrid({
				...
				striped: true,
				collapsible: true,
				url: '${contextPath}/heathcare/medicalExamination/reviewJson?gradeId=${gradeId}&tenantId=${tenantId}&type=${type}&personId=${personId}&checkId=${checkId}',
				remoteSort: false,
				singleSelect: true,
				idField: 'id',
				columns:[[
	...
	function exportXls(){
		...
		var link="${contextPath}/heathcare/tenantReportMain/exportXls?reportId=TenantMedicalExaminationSicknessPositiveSign&checkId=${checkId}&tenantId=${tenantId}";
		if(gradeId != ""){
	...
	function exportXls2(){
		var link="${contextPath}/heathcare/tenantReportMain/exportXls?reportId=TenantGrowth&personId=${personId}&checkId=${checkId}&tenantId=${tenantId}";
        window.open(link);
    }
    ...
    <div data-options="region:'west', split:true" style="width:225px;">
	  <div class="easyui-layout" data-options="fit:true"> 
		  <div data-options="region:'center', border:false">
		      <select id="checkId" name="checkId" onchange="javascript:changeCheck();" style="width:218px;">
				<option value="">----请选择----</option>
				<#list examList as exam>
				<option value="${exam.checkId}">${exam.title}</option>
				</#list> 
		      </select>
              <script type="text/javascript">
