...
<script language="javascript">
    ...
    function removeElement() {
	 ...
	 function saveData() {
		...
		jQuery.ajax({
				   type: "POST",
				   url: '${contextPath}/heathcare/gradeInfo/saveGradeUsers',
				   data: params,
				   dataType:  'json',
				   error: function(data){
					   alert('服务器处理错误！');
	...
	function switchXY(){
		 document.iForm.action="${contextPath}/heathcare/gradeInfo/gradeUsers";
