...
<head>
    ...
    <link rel="stylesheet" href="${contextPath}/static/css/iconfront.css">
    <style type="text/css">

        @font-face {font-family: "iconfont";
          src: url('${contextPath}/static/plugins/layui/font/iconfont.eot'); /* IE9*/
          src: url('${contextPath}/static/plugins/layui/font/iconfont.eot#iefix') format('embedded-opentype'), /* IE6-IE8 */
          url('${contextPath}/static/plugins/layui/font/iconfont.woff') format('woff'), /* chrome, firefox */
          url('${contextPath}/static/plugins/layui/font/iconfont.ttf') format('truetype'), /* chrome, firefox, opera, Safari, Android, iOS 4.2+*/
          url('${contextPath}/static/plugins/layui/font/iconfont.svg#iconfont') format('svg'); /* iOS 4.1- */
        }
