...
<br>
 ...
 <script type="text/javascript"> 
  ...
  YAHOO.example.DynamicData = ( function() {
    ...
    var s_link = "${request.contextPath}/flowable/task/taskListJson?q=1"+x_app;
	...
	function onMyDblClickRow(oArgs) {
	 ...
	 var formatFunKey = function(elCell, oRecord, oColumn, oData) {
		...
		var link2 ='${request.contextPath}/flowable/image/viewImage?processInstanceId='+processInstanceId;
