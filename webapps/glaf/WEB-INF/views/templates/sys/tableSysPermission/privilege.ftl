...
<script language="javascript">
    ...
    function removeElement() {
	 ...
	 function saveData() {
		...
		jQuery.ajax({
				   type: "POST",
				   url: '${contextPath}/sys/tableSysPermission/savePrivileges',
				   data: params,
				   dataType:  'json',
				   error: function(data){
					   alert('服务器处理错误！');
	...
	function switchXY(){
		 //alert(document.getElementById("granteeType").value);
		 document.iForm.action="${contextPath}/sys/tableSysPermission/privilege";
...
<div class="x_content_title">
    <img src="${contextPath}/static/images/window.png" alt="权限设置">&nbsp;权限设置
</div>
