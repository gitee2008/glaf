...
<script language="javascript">
    ...
    function saveData(){
		...
		jQuery.ajax({
				   type: "POST",
				   url: '${contextPath}/tenant/user/saveModify',
				   data: params,
				   dataType:  'json',
				   error: function(data){
					   alert('服务器处理错误！');
...
<form id="iForm" name="iForm" action="${contextPath}/tenant/user/saveModify" method="post"  > 
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="box">
  ...
  <tr>
    <td class="box-mm"><table width="95%" align="center" border="0" cellspacing="0" cellpadding="5">
      <tr>
        <td width="20%" class="input-box2">用户账号</td>
      ...
      <tr>
        ...
        <td>
          <input type="radio" name="locked" value="0" <#if user.locked==0>checked</#if>>有效
          <input type="radio" name="locked" value="1" <#if user.locked==1>checked</#if>>无效
		  &nbsp;&nbsp;(选中无效后，用户将不能登录系统！！！)
		</td>
      </tr>
