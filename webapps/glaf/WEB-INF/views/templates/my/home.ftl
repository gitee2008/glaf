...
<div class="wrapper">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="${request.contextPath}/static/images/2.png" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="${request.contextPath}/static/images/2.png" class="user-image" alt="${username}">
              <span class="hidden-xs">${username}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="${request.contextPath}/static/images/2.png" class="img-circle" alt="${username}">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="#" onclick="javascript:logout();" class="btn btn-default btn-flat">退出</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <#list topTrees as top>
		<li class="treeview">
          <a href="#" <#if top.url?exists>onclick="javascript:openUrl('${top.url}');"</#if>>
            <i class="fa fa-th"></i> <span>${top.title}</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
		  <#if top.components?exists>
		   <ul class="treeview-menu">
		   <#list top.components as child>
            <li class="treeview">
                <a href="#" <#if child.url?exists>onclick="javascript:openUrl('${child.url}');"</#if> ><i class="fa fa-circle-o"></i> ${child.title}
                  <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                  </span>
                </a>
			    <#if child.components?exists>
				  <ul class="treeview-menu">
				   <#list child.components as node>
                    <li><a href="#" onclick="javascript:openUrl('${node.url}');"><i class="fa fa-circle-o"></i> ${node.title}</a></li>
				   </#list>
				  </ul>
		        </#if>
            </li>
  ...
  <div class="content-wrapper" id="mainContent">
    ...
    <section class="content">
	  <div id="mainContent">
         <!-- <iframe id="mainFrame" name="mainFrame" frameborder="0" width="1366" height="768" 
...
<!-- jQuery 3 -->
<script src="${request.contextPath}/static/AdminLTE/bower_components/jquery/dist/jquery.min.js"></script>
<!-- Bootstrap 3.3.7 -->
...
<script type="text/javascript">
	...
	function openUrl(url){
		...
		var link='<iframe id="newFrame2" name="newFrame2" scrolling="yes" frameborder="0" width="'+x_width+'" height="'+x_height+'" src="'+url+'"></iframe>';
		jQuery("#mainContent").html(link);
		//alert(link);
		//alert(mainContent);
        //mainContent.html(link);
		//jQuery("#mainContent").load(url);
		//var mainFrame = document.getElementById("mainFrame");
		//mainFrame.src=url;
		//alert(url);
		//alert(jQuery("#mainFrame"));
		//jQuery("#mainFrame").src(url);     
	}
