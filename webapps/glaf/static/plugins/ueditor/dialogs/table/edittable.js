...
(function () {
    var title = $G("J_title"),
        ...
        autoEllipsis = $G("J_autoEllipsis"),  //按单元格宽度自动省略号
        tone = $G("J_tone"),
        me,
        preview = $G("J_preview");
    ...
    editTable.prototype = {
        init:function () {
            ...
            domUtils.on(autoEllipsis, "click", me.autoEllipsisHanler);//按单元格宽度自动省略号
        ...
        autoEllipsisHanler:function(){   //按单元格宽度自动省略号
            // var example = $G("J_example");
            // var tds = example.getElementsByTagName(example, "td");
            // utils.each(tds, function (td) {
            //     td.removeAttribute("width");
    ...
    dialog.onok = function () {
        ...
        autoEllipsis.checked ? editor.execCommand("ellipsisbywidth") : "";//按单元格宽度自动省略号
        editor.fireEvent('saveScene');
