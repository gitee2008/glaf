...
public class ImgQrTool {
	...
	public static void main(String[] args) throws IOException {
		for (int i = 1; i <= 1; i++) {
			QrImage para = new QrImage.Builder().setFileOutputPath("E:\\qrcode\\test\\" + i + ".jpg")
					.setQrContent("http://www.baidu.com?a=qrcode").setQrHeight(320).setQrWidth(320)
					.setQrIconFilePath("E:\\qrcode\\1.png").setTopWrodHeight(120).setWordContent("test" + 1)
