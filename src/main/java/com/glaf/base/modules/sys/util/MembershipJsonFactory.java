...
public class MembershipJsonFactory {
	...
	public static JSONObject toJsonObject(Membership model) {
		...
		if (model.getModifyDate() != null) {
			jsonObject.put("modifyDate", DateUtils.getDate(model.getModifyDate()));
			jsonObject.put("modifyDate_date", DateUtils.getDate(model.getModifyDate()));
			jsonObject.put("modifyDate_datetime", DateUtils.getDateTime(model.getModifyDate()));
		}
