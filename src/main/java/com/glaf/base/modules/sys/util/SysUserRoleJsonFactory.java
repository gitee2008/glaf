...
public class SysUserRoleJsonFactory {
	...
	public static SysUserRole jsonToObject(JSONObject jsonObject) {
		...
		if (jsonObject.containsKey("authorizeFrom")) {
			model.setAuthorizeFrom(jsonObject.getString("authorizeFrom"));
		}
		...
		if (jsonObject.containsKey("processDescription")) {
			model.setProcessDescription(jsonObject.getString("processDescription"));
		}
	...
	public static JSONObject toJsonObject(SysUserRole model) {
		...
		if (model.getAvailDateStart() != null) {
			jsonObject.put("availDateStart", DateUtils.getDate(model.getAvailDateStart()));
			jsonObject.put("availDateStart_date", DateUtils.getDate(model.getAvailDateStart()));
			jsonObject.put("availDateStart_datetime", DateUtils.getDateTime(model.getAvailDateStart()));
		}
		if (model.getAvailDateEnd() != null) {
			jsonObject.put("availDateEnd", DateUtils.getDate(model.getAvailDateEnd()));
			jsonObject.put("availDateEnd_date", DateUtils.getDate(model.getAvailDateEnd()));
			jsonObject.put("availDateEnd_datetime", DateUtils.getDateTime(model.getAvailDateEnd()));
		}
