...
public interface MembershipService {
	 ...
	 * @return
	 */
	List<Membership> getMembershipsByQueryCriteria(int start, int pageSize, MembershipQuery query);
	 ...
	 */
	@Transactional
	void saveMemberships(Long nodeId, String roleId, String type, List<Membership> memberships);
