...
public class UserThemeController {
	protected static final Log logger = LogFactory.getLog(UserThemeController.class);
		...
		if (StringUtils.isNotEmpty(ids)) {
			...
			while (token.hasMoreTokens()) {
				...
				if (StringUtils.isNotEmpty(x)) {
					UserTheme userTheme = userThemeService.getUserTheme(Integer.valueOf(x));
					/**
					 * 此处业务逻辑需自行调整
					 */
					if (userTheme != null && (StringUtils.equals(userTheme.getCreateBy(), loginContext.getActorId())
			...
			UserTheme userTheme = userThemeService.getUserTheme(Integer.valueOf(id));
			/**
			 * 此处业务逻辑需自行调整
			 */
			if (userTheme != null && (StringUtils.equals(userTheme.getCreateBy(), loginContext.getActorId())
	...
	public ModelAndView edit(HttpServletRequest request, ModelMap modelMap) {
		...
		UserTheme userTheme = userThemeService.getUserTheme(RequestUtils.getInt(request, "id"));
		if (userTheme != null) {
		...
		return new ModelAndView("/ui/userTheme/edit", modelMap);
	}
	...
	public byte[] json(HttpServletRequest request, ModelMap modelMap) throws IOException {
		...
		if (total > 0) {
			...
			List<UserTheme> list = userThemeService.getUserThemesByQueryCriteria(start, limit, query);
	...
	public ModelAndView list(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/ui/userTheme/list", modelMap);
	}
	...
	public ModelAndView query(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/ui/userTheme/query", modelMap);
	}
	...
	public @ResponseBody UserTheme saveOrUpdate(HttpServletRequest request, @RequestBody Map<String, Object> model) {
		User user = RequestUtils.getUser(request);
		String actorId = user.getActorId();
		UserTheme userTheme = new UserTheme();
		try {
			...
			userTheme.setLayoutModel(ParamUtils.getString(model, "layoutModel"));
			userTheme.setBackground(ParamUtils.getString(model, "background"));
			userTheme.setBackgroundType(ParamUtils.getString(model, "backgroundType"));
	...
	public ModelAndView view(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/ui/userTheme/view");
	}
