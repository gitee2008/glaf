...
public class Panel implements Serializable {
	...
	@Column(name = "ZIFRAME_")
	protected int ziframe;

	@Transient
	protected List<PanelButton> panelButtons = null;
	...
	public List<PanelButton> getPanelButtons() {
		return panelButtons;
	}

	public void setPanelButtons(List<PanelButton> panelButtons) {
		this.panelButtons = panelButtons;
	}

	public int getZiframe() {
		return ziframe;
	}

	public void setZiframe(int ziframe) {
		this.ziframe = ziframe;
	}
