 ...
 *
 */
public class RemotePermissionDomainFactory {

	public static final String TABLENAME = "SYS_REMOTE_PERMISSION";
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("RemotePermission");
	...
	private RemotePermissionDomainFactory() {
