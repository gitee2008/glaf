 ...
 *
 */
public class TriphopathiaDomainFactory {

	public static final String TABLENAME = "HEALTH_TRIPHOPATHIA";
	...
	static {
		...
		columnMap.put("diseaseName", "DISEASENAME_");
		columnMap.put("discoverDate", "DISCOVERDATE_");
		columnMap.put("clinicDate", "CLINICDATE_");
		columnMap.put("clinicOrg", "CLINICORG_");
		columnMap.put("medicalHistory", "MEDICALHISTORY_");
		columnMap.put("archivingDate", "ARCHIVINGDATE_");
		columnMap.put("closeDate", "CLOSEDATE_");
		columnMap.put("clinicalSituation", "CLINICALSITUATION_");
		...
		javaTypeMap.put("diseaseName", "String");
		javaTypeMap.put("discoverDate", "Date");
		javaTypeMap.put("clinicDate", "Date");
		javaTypeMap.put("clinicOrg", "String");
		javaTypeMap.put("medicalHistory", "String");
		javaTypeMap.put("archivingDate", "Date");
		javaTypeMap.put("closeDate", "Date");
		javaTypeMap.put("clinicalSituation", "String");
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("Triphopathia");
		...
		ColumnDefinition diseaseName = new ColumnDefinition();
		diseaseName.setName("diseaseName");
		diseaseName.setColumnName("DISEASENAME_");
		diseaseName.setJavaType("String");
		diseaseName.setLength(200);
		tableDefinition.addColumn(diseaseName);

		ColumnDefinition discoverDate = new ColumnDefinition();
		discoverDate.setName("discoverDate");
		discoverDate.setColumnName("DISCOVERDATE_");
		discoverDate.setJavaType("Date");
		tableDefinition.addColumn(discoverDate);

		ColumnDefinition clinicDate = new ColumnDefinition();
		clinicDate.setName("clinicDate");
		clinicDate.setColumnName("CLINICDATE_");
		clinicDate.setJavaType("Date");
		tableDefinition.addColumn(clinicDate);

		ColumnDefinition clinicOrg = new ColumnDefinition();
		clinicOrg.setName("clinicOrg");
		clinicOrg.setColumnName("CLINICORG_");
		clinicOrg.setJavaType("String");
		clinicOrg.setLength(200);
		tableDefinition.addColumn(clinicOrg);

		ColumnDefinition medicalHistory = new ColumnDefinition();
		medicalHistory.setName("medicalHistory");
		medicalHistory.setColumnName("MEDICALHISTORY_");
		medicalHistory.setJavaType("String");
		medicalHistory.setLength(200);
		tableDefinition.addColumn(medicalHistory);

		ColumnDefinition archivingDate = new ColumnDefinition();
		archivingDate.setName("archivingDate");
		archivingDate.setColumnName("ARCHIVINGDATE_");
		archivingDate.setJavaType("Date");
		tableDefinition.addColumn(archivingDate);

		ColumnDefinition closeDate = new ColumnDefinition();
		closeDate.setName("closeDate");
		closeDate.setColumnName("CLOSEDATE_");
		closeDate.setJavaType("Date");
		tableDefinition.addColumn(closeDate);

		ColumnDefinition clinicalSituation = new ColumnDefinition();
		clinicalSituation.setName("clinicalSituation");
		clinicalSituation.setColumnName("CLINICALSITUATION_");
		clinicalSituation.setJavaType("String");
		clinicalSituation.setLength(200);
		tableDefinition.addColumn(clinicalSituation);
	...
	private TriphopathiaDomainFactory() {
