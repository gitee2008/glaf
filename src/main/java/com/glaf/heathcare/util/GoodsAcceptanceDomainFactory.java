 ...
 *
 */
public class GoodsAcceptanceDomainFactory {

	public static final String TABLENAME = "GOODS_ACCEPTANCE";
	...
	static {
		...
		columnMap.put("acceptanceTime", "ACCEPTANCE_TIME_");
		...
		javaTypeMap.put("acceptanceTime", "Date");
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("GoodsAcceptance");
		...
		ColumnDefinition acceptanceTime = new ColumnDefinition();
		acceptanceTime.setName("acceptanceTime");
		acceptanceTime.setColumnName("ACCEPTANCE_TIME_");
		acceptanceTime.setJavaType("Date");
		tableDefinition.addColumn(acceptanceTime);
	...
	private GoodsAcceptanceDomainFactory() {
