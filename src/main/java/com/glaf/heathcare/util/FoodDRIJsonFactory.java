 ...
 *
 */
public class FoodDRIJsonFactory {

	public static FoodDRI jsonToObject(JSONObject jsonObject) {
		FoodDRI model = new FoodDRI();
	...
	public static JSONObject toJsonObject(FoodDRI model) {
	...
	public static ObjectNode toObjectNode(FoodDRI model) {
	...
	public static JSONArray listToArray(java.util.List<FoodDRI> list) {
		JSONArray array = new JSONArray();
		if (list != null && !list.isEmpty()) {
			for (FoodDRI model : list) {
	...
	public static java.util.List<FoodDRI> arrayToList(JSONArray array) {
		java.util.List<FoodDRI> list = new java.util.ArrayList<FoodDRI>();
		for (int i = 0, len = array.size(); i < len; i++) {
			JSONObject jsonObject = array.getJSONObject(i);
			FoodDRI model = jsonToObject(jsonObject);
			list.add(model);
		}
		return list;
	}

	private FoodDRIJsonFactory() {
