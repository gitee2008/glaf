 ...
 *
 */
public class FoodDRIPercentDomainFactory {

	public static final String TABLENAME = "HEALTH_FOOD_DRI_PERCENT";
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("FoodDRIPercent");
	...
	private FoodDRIPercentDomainFactory() {
