 ...
 *
 */
public class GoodsPlanQuantityDomainFactory {

	public static final String TABLENAME = "GOODS_PLAN_QUANTITY";
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("GoodsPlanQuantity");
	...
	private GoodsPlanQuantityDomainFactory() {
