 ...
 *
 */
public class GoodsPlanQuantityJsonFactory {

	public static GoodsPlanQuantity jsonToObject(JSONObject jsonObject) {
		GoodsPlanQuantity model = new GoodsPlanQuantity();
	...
	public static JSONObject toJsonObject(GoodsPlanQuantity model) {
	...
	public static ObjectNode toObjectNode(GoodsPlanQuantity model) {
	...
	public static JSONArray listToArray(java.util.List<GoodsPlanQuantity> list) {
		JSONArray array = new JSONArray();
		if (list != null && !list.isEmpty()) {
			for (GoodsPlanQuantity model : list) {
	...
	public static java.util.List<GoodsPlanQuantity> arrayToList(JSONArray array) {
		java.util.List<GoodsPlanQuantity> list = new java.util.ArrayList<GoodsPlanQuantity>();
		for (int i = 0, len = array.size(); i < len; i++) {
			JSONObject jsonObject = array.getJSONObject(i);
			GoodsPlanQuantity model = jsonToObject(jsonObject);
			list.add(model);
		}
		return list;
	}

	private GoodsPlanQuantityJsonFactory() {
