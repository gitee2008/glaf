 ...
 *
 */
public class VaccinationDomainFactory {

	public static final String TABLENAME = "HEALTH_VACCINATION";
	...
	static {
		...
		columnMap.put("vaccine", "VACCINE_");
		columnMap.put("sortNo", "SORTNO_");
		columnMap.put("inoculateDate", "INOCULATEDATE_");
		columnMap.put("doctor", "DOCTOR_");
		...
		javaTypeMap.put("vaccine", "String");
		javaTypeMap.put("sortNo", "Integer");
		javaTypeMap.put("inoculateDate", "Date");
		javaTypeMap.put("doctor", "String");
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("Vaccination");
		...
		ColumnDefinition vaccine = new ColumnDefinition();
		vaccine.setName("vaccine");
		vaccine.setColumnName("VACCINE_");
		vaccine.setJavaType("String");
		vaccine.setLength(200);
		tableDefinition.addColumn(vaccine);
		...
		ColumnDefinition inoculateDate = new ColumnDefinition();
		inoculateDate.setName("inoculateDate");
		inoculateDate.setColumnName("INOCULATEDATE_");
		inoculateDate.setJavaType("Date");
		tableDefinition.addColumn(inoculateDate);

		ColumnDefinition doctor = new ColumnDefinition();
		doctor.setName("doctor");
		doctor.setColumnName("DOCTOR_");
		doctor.setJavaType("String");
		doctor.setLength(50);
		tableDefinition.addColumn(doctor);
	...
	private VaccinationDomainFactory() {
