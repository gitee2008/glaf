 ...
 *
 */
public class PersonRefundJsonFactory {

	public static java.util.List<PersonRefund> arrayToList(JSONArray array) {
		java.util.List<PersonRefund> list = new java.util.ArrayList<PersonRefund>();
		for (int i = 0, len = array.size(); i < len; i++) {
			JSONObject jsonObject = array.getJSONObject(i);
			PersonRefund model = jsonToObject(jsonObject);
			list.add(model);
		}
		return list;
	}

	public static PersonRefund jsonToObject(JSONObject jsonObject) {
		PersonRefund model = new PersonRefund();
		...
		if (jsonObject.containsKey("refundTime")) {
			model.setRefundTime(jsonObject.getDate("refundTime"));
		}
	...
	public static JSONArray listToArray(java.util.List<PersonRefund> list) {
		JSONArray array = new JSONArray();
		if (list != null && !list.isEmpty()) {
			for (PersonRefund model : list) {
	...
	public static JSONObject toJsonObject(PersonRefund model) {
		...
		if (model.getRefundTime() != null) {
			jsonObject.put("refundTime", DateUtils.getDate(model.getRefundTime()));
			jsonObject.put("refundTime_date", DateUtils.getDate(model.getRefundTime()));
			jsonObject.put("refundTime_datetime", DateUtils.getDateTime(model.getRefundTime()));
		}
	...
	public static ObjectNode toObjectNode(PersonRefund model) {
	...
	private PersonRefundJsonFactory() {
