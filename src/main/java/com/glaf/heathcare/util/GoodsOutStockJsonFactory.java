 ...
 *
 */
public class GoodsOutStockJsonFactory {

	public static GoodsOutStock jsonToObject(JSONObject jsonObject) {
		...
		if (jsonObject.containsKey("outStockTime")) {
			model.setOutStockTime(jsonObject.getDate("outStockTime"));
		}
	...
	public static JSONObject toJsonObject(GoodsOutStock model) {
		...
		if (model.getOutStockTime() != null) {
			jsonObject.put("outStockTime", DateUtils.getDate(model.getOutStockTime()));
			jsonObject.put("outStockTime_date", DateUtils.getDate(model.getOutStockTime()));
			jsonObject.put("outStockTime_datetime", DateUtils.getDateTime(model.getOutStockTime()));
		}
	...
	public static ObjectNode toObjectNode(GoodsOutStock model) {
	...
	public static JSONArray listToArray(java.util.List<GoodsOutStock> list) {
	...
	public static java.util.List<GoodsOutStock> arrayToList(JSONArray array) {
		java.util.List<GoodsOutStock> list = new java.util.ArrayList<GoodsOutStock>();
		for (int i = 0, len = array.size(); i < len; i++) {
			JSONObject jsonObject = array.getJSONObject(i);
			GoodsOutStock model = jsonToObject(jsonObject);
			list.add(model);
		}
		return list;
	}

	private GoodsOutStockJsonFactory() {
