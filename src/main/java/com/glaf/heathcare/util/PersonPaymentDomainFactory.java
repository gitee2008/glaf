 ...
 *
 */
public class PersonPaymentDomainFactory {

	public static final String TABLENAME = "HEALTH_PERSON_PAYMENT";
	...
	static {
		...
		columnMap.put("money", "MONEY_");
		columnMap.put("payTime", "PAYTIME_");
		...
		javaTypeMap.put("money", "Double");
		javaTypeMap.put("payTime", "Date");
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("PersonPayment");
		...
		ColumnDefinition money = new ColumnDefinition();
		money.setName("money");
		money.setColumnName("MONEY_");
		money.setJavaType("Double");
		tableDefinition.addColumn(money);

		ColumnDefinition payTime = new ColumnDefinition();
		payTime.setName("payTime");
		payTime.setColumnName("PAYTIME_");
		payTime.setJavaType("Date");
		tableDefinition.addColumn(payTime);
	...
	private PersonPaymentDomainFactory() {
