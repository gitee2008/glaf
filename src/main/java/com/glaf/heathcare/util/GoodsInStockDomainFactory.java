 ...
 *
 */
public class GoodsInStockDomainFactory {

	public static final String TABLENAME = "GOODS_IN_STOCK";
	...
	static {
		...
		columnMap.put("inStockTime", "INSTOCKTIME_");
		...
		columnMap.put("available", "AVAILABLE_");
		...
		javaTypeMap.put("inStockTime", "Date");
		...
		javaTypeMap.put("available", "Integer");
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("GoodsInStock");
		...
		ColumnDefinition inStockTime = new ColumnDefinition();
		inStockTime.setName("inStockTime");
		inStockTime.setColumnName("INSTOCKTIME_");
		inStockTime.setJavaType("Date");
		tableDefinition.addColumn(inStockTime);
		...
		ColumnDefinition available = new ColumnDefinition();
		available.setName("available");
		available.setColumnName("AVAILABLE_");
		available.setJavaType("Integer");
		tableDefinition.addColumn(available);
	...
	private GoodsInStockDomainFactory() {
