 ...
 *
 */
public class GoodsPurchasePlanDomainFactory {

	public static final String TABLENAME = "GOODS_PURCHASE_PLAN";
	...
	static {
		...
		columnMap.put("weeklyFlag", "WEEKLYFLAG_");
		...
		javaTypeMap.put("weeklyFlag", "String");
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("GoodsPurchasePlan");
		...
		ColumnDefinition weeklyFlag = new ColumnDefinition();
		weeklyFlag.setName("weeklyFlag");
		weeklyFlag.setColumnName("WEEKLYFLAG_");
		weeklyFlag.setJavaType("String");
		weeklyFlag.setLength(1);
		tableDefinition.addColumn(weeklyFlag);
	...
	private GoodsPurchasePlanDomainFactory() {
