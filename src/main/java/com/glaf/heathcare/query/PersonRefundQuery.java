...
public class PersonRefundQuery extends DataQuery {
	...
	public PersonRefundQuery() {

	}

	public PersonRefundQuery businessStatus(Integer businessStatus) {
	...
	public PersonRefundQuery createTimeGreaterThanOrEqual(Date createTimeGreaterThanOrEqual) {
	...
	public PersonRefundQuery createTimeLessThanOrEqual(Date createTimeLessThanOrEqual) {
	...
	public PersonRefundQuery gradeId(String gradeId) {
		if (gradeId == null) {
	...
	public PersonRefundQuery gradeIds(List<String> gradeIds) {
		if (gradeIds == null) {
	...
	public void initQueryColumns() {
		...
		addColumn("refundTime", "REFUNDTIME_");
	...
	public PersonRefundQuery month(Integer month) {
		if (month == null) {
	...
	public PersonRefundQuery personId(String personId) {
		if (personId == null) {
	...
	public PersonRefundQuery personIds(List<String> personIds) {
		if (personIds == null) {
	...
	public PersonRefundQuery remarkLike(String remarkLike) {
		if (remarkLike == null) {
	...
	public PersonRefundQuery semester(Integer semester) {
		if (semester == null) {
	...
	public PersonRefundQuery tenantId(String tenantId) {
		if (tenantId == null) {
	...
	public PersonRefundQuery type(String type) {
		if (type == null) {
	...
	public PersonRefundQuery year(Integer year) {
		if (year == null) {
