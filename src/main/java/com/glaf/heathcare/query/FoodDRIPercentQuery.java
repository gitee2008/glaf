...
public class FoodDRIPercentQuery extends DataQuery {
	...
	public FoodDRIPercentQuery name(String name) {
		if (name == null) {
	...
	public FoodDRIPercentQuery nameLike(String nameLike) {
		if (nameLike == null) {
			throw new RuntimeException("name is null");
		}
		this.nameLike = nameLike;
	...
	public FoodDRIPercentQuery descriptionLike(String descriptionLike) {
	...
	public FoodDRIPercentQuery ageGroup(String ageGroup) {
		if (ageGroup == null) {
	...
	public FoodDRIPercentQuery type(String type) {
		if (type == null) {
	...
	public FoodDRIPercentQuery typeLike(String typeLike) {
		if (typeLike == null) {
			throw new RuntimeException("type is null");
		}
		this.typeLike = typeLike;
	...
	public FoodDRIPercentQuery typeId(Long typeId) {
		if (typeId == null) {
	...
	public FoodDRIPercentQuery typeIds(List<Long> typeIds) {
		if (typeIds == null) {
	...
	public FoodDRIPercentQuery heatEnergyGreaterThanOrEqual(Double heatEnergyGreaterThanOrEqual) {
	...
	public FoodDRIPercentQuery heatEnergyLessThanOrEqual(Double heatEnergyLessThanOrEqual) {
	...
	public FoodDRIPercentQuery proteinGreaterThanOrEqual(Double proteinGreaterThanOrEqual) {
	...
	public FoodDRIPercentQuery proteinLessThanOrEqual(Double proteinLessThanOrEqual) {
	...
	public FoodDRIPercentQuery fatGreaterThanOrEqual(Double fatGreaterThanOrEqual) {
	...
	public FoodDRIPercentQuery fatLessThanOrEqual(Double fatLessThanOrEqual) {
	...
	public FoodDRIPercentQuery carbohydrateGreaterThanOrEqual(Double carbohydrateGreaterThanOrEqual) {
	...
	public FoodDRIPercentQuery carbohydrateLessThanOrEqual(Double carbohydrateLessThanOrEqual) {
	...
	public FoodDRIPercentQuery vitaminAGreaterThanOrEqual(Double vitaminAGreaterThanOrEqual) {
	...
	public FoodDRIPercentQuery vitaminALessThanOrEqual(Double vitaminALessThanOrEqual) {
	...
	public FoodDRIPercentQuery vitaminB1GreaterThanOrEqual(Double vitaminB1GreaterThanOrEqual) {
	...
	public FoodDRIPercentQuery vitaminB1LessThanOrEqual(Double vitaminB1LessThanOrEqual) {
	...
	public FoodDRIPercentQuery vitaminB2GreaterThanOrEqual(Double vitaminB2GreaterThanOrEqual) {
	...
	public FoodDRIPercentQuery vitaminB2LessThanOrEqual(Double vitaminB2LessThanOrEqual) {
	...
	public FoodDRIPercentQuery vitaminB6GreaterThanOrEqual(Double vitaminB6GreaterThanOrEqual) {
	...
	public FoodDRIPercentQuery vitaminB6LessThanOrEqual(Double vitaminB6LessThanOrEqual) {
	...
	public FoodDRIPercentQuery vitaminB12GreaterThanOrEqual(Double vitaminB12GreaterThanOrEqual) {
	...
	public FoodDRIPercentQuery vitaminB12LessThanOrEqual(Double vitaminB12LessThanOrEqual) {
	...
	public FoodDRIPercentQuery vitaminCGreaterThanOrEqual(Double vitaminCGreaterThanOrEqual) {
	...
	public FoodDRIPercentQuery vitaminCLessThanOrEqual(Double vitaminCLessThanOrEqual) {
	...
	public FoodDRIPercentQuery caroteneGreaterThanOrEqual(Double caroteneGreaterThanOrEqual) {
	...
	public FoodDRIPercentQuery caroteneLessThanOrEqual(Double caroteneLessThanOrEqual) {
	...
	public FoodDRIPercentQuery retinolGreaterThanOrEqual(Double retinolGreaterThanOrEqual) {
	...
	public FoodDRIPercentQuery retinolLessThanOrEqual(Double retinolLessThanOrEqual) {
	...
	public FoodDRIPercentQuery nicotinicCidGreaterThanOrEqual(Double nicotinicCidGreaterThanOrEqual) {
	...
	public FoodDRIPercentQuery nicotinicCidLessThanOrEqual(Double nicotinicCidLessThanOrEqual) {
	...
	public FoodDRIPercentQuery calciumGreaterThanOrEqual(Double calciumGreaterThanOrEqual) {
	...
	public FoodDRIPercentQuery calciumLessThanOrEqual(Double calciumLessThanOrEqual) {
	...
	public FoodDRIPercentQuery ironGreaterThanOrEqual(Double ironGreaterThanOrEqual) {
	...
	public FoodDRIPercentQuery ironLessThanOrEqual(Double ironLessThanOrEqual) {
	...
	public FoodDRIPercentQuery zincGreaterThanOrEqual(Double zincGreaterThanOrEqual) {
	...
	public FoodDRIPercentQuery zincLessThanOrEqual(Double zincLessThanOrEqual) {
	...
	public FoodDRIPercentQuery enableFlag(String enableFlag) {
		if (enableFlag == null) {
	...
	public FoodDRIPercentQuery createTimeGreaterThanOrEqual(Date createTimeGreaterThanOrEqual) {
	...
	public FoodDRIPercentQuery createTimeLessThanOrEqual(Date createTimeLessThanOrEqual) {
	...
	public FoodDRIPercentQuery updateTimeGreaterThanOrEqual(Date updateTimeGreaterThanOrEqual) {
	...
	public FoodDRIPercentQuery updateTimeLessThanOrEqual(Date updateTimeLessThanOrEqual) {
