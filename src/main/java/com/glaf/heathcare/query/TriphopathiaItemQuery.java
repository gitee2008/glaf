...
public class TriphopathiaItemQuery extends DataQuery {
	private static final long serialVersionUID = 1L;
	protected Long triphopathiaId;
	protected List<Long> triphopathiaIds;
	...
	public TriphopathiaItemQuery() {

	}

	public TriphopathiaItemQuery ageOfTheMoon(Integer ageOfTheMoon) {
	...
	public TriphopathiaItemQuery bmiGreaterThanOrEqual(Double bmiGreaterThanOrEqual) {
	...
	public TriphopathiaItemQuery bmiIndexGreaterThanOrEqual(Double bmiIndexGreaterThanOrEqual) {
	...
	public TriphopathiaItemQuery bmiIndexLessThanOrEqual(Double bmiIndexLessThanOrEqual) {
	...
	public TriphopathiaItemQuery bmiLessThanOrEqual(Double bmiLessThanOrEqual) {
	...
	public TriphopathiaItemQuery checkDoctorId(String checkDoctorId) {
	...
	public TriphopathiaItemQuery createBy(String createBy) {
		if (createBy == null) {
	...
	public TriphopathiaItemQuery createTimeGreaterThanOrEqual(Date createTimeGreaterThanOrEqual) {
	...
	public TriphopathiaItemQuery createTimeLessThanOrEqual(Date createTimeLessThanOrEqual) {
	...
	public List<Long> getTriphopathiaIds() {
		return triphopathiaIds;
	}
	...
	public TriphopathiaItemQuery gradeId(String gradeId) {
		if (gradeId == null) {
	...
	public TriphopathiaItemQuery gradeIds(List<String> gradeIds) {
		if (gradeIds == null) {
	...
	public TriphopathiaItemQuery heightGreaterThanOrEqual(Double heightGreaterThanOrEqual) {
	...
	public TriphopathiaItemQuery heightLessThanOrEqual(Double heightLessThanOrEqual) {
	...
	public TriphopathiaItemQuery heightLevel(Integer heightLevel) {
		if (heightLevel == null) {
	...
	public TriphopathiaItemQuery heightLevelGreaterThanOrEqual(Integer heightLevelGreaterThanOrEqual) {
	...
	public TriphopathiaItemQuery heightLevelLessThanOrEqual(Integer heightLevelLessThanOrEqual) {
	...
	public TriphopathiaItemQuery name(String name) {
		if (name == null) {
	...
	public TriphopathiaItemQuery nameLike(String nameLike) {
		if (nameLike == null) {
			throw new RuntimeException("name is null");
		}
	...
	public TriphopathiaItemQuery personId(String personId) {
		if (personId == null) {
	...
	public TriphopathiaItemQuery personIds(List<String> personIds) {
		if (personIds == null) {
	...
	public TriphopathiaItemQuery remarkLike(String remarkLike) {
		if (remarkLike == null) {
	...
	public void setTriphopathiaIds(List<Long> triphopathiaIds) {
		this.triphopathiaIds = triphopathiaIds;
	}
	...
	public TriphopathiaItemQuery sex(String sex) {
		if (sex == null) {
	...
	public TriphopathiaItemQuery tenantId(String tenantId) {
		if (tenantId == null) {
	...
	public TriphopathiaItemQuery tenantIds(List<String> tenantIds) {
		if (tenantIds == null) {
	...
	public TriphopathiaItemQuery triphopathiaId(Long triphopathiaId) {
		if (triphopathiaId == null) {
			throw new RuntimeException("triphopathiaId is null");
		}
		this.triphopathiaId = triphopathiaId;
		return this;
	}

	public TriphopathiaItemQuery triphopathiaIds(List<Long> triphopathiaIds) {
		if (triphopathiaIds == null) {
			throw new RuntimeException("triphopathiaIds is empty ");
		}
		this.triphopathiaIds = triphopathiaIds;
		return this;
	}

	public TriphopathiaItemQuery type(String type) {
		if (type == null) {
	...
	public TriphopathiaItemQuery weightGreaterThanOrEqual(Double weightGreaterThanOrEqual) {
	...
	public TriphopathiaItemQuery weightHeightPercentGreaterThanOrEqual(Double weightHeightPercentGreaterThanOrEqual) {
	...
	public TriphopathiaItemQuery weightHeightPercentLessThanOrEqual(Double weightHeightPercentLessThanOrEqual) {
	...
	public TriphopathiaItemQuery weightLessThanOrEqual(Double weightLessThanOrEqual) {
	...
	public TriphopathiaItemQuery weightLevel(Integer weightLevel) {
		if (weightLevel == null) {
	...
	public TriphopathiaItemQuery weightLevelGreaterThanOrEqual(Integer weightLevelGreaterThanOrEqual) {
	...
	public TriphopathiaItemQuery weightLevelLessThanOrEqual(Integer weightLevelLessThanOrEqual) {
