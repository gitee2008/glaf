...
public class GoodsActualQuantityQuery extends DataQuery {
	...
	public GoodsActualQuantityQuery() {

	}

	public GoodsActualQuantityQuery businessStatus(Integer businessStatus) {
	...
	public GoodsActualQuantityQuery confirmBy(String confirmBy) {
		if (confirmBy == null) {
	...
	public GoodsActualQuantityQuery confirmTimeGreaterThanOrEqual(Date confirmTimeGreaterThanOrEqual) {
	...
	public GoodsActualQuantityQuery confirmTimeLessThanOrEqual(Date confirmTimeLessThanOrEqual) {
	...
	public GoodsActualQuantityQuery createTimeGreaterThanOrEqual(Date createTimeGreaterThanOrEqual) {
	...
	public GoodsActualQuantityQuery createTimeLessThanOrEqual(Date createTimeLessThanOrEqual) {
	...
	public GoodsActualQuantityQuery day(Integer day) {
		if (day == null) {
	...
	public GoodsActualQuantityQuery fullDay(Integer fullDay) {
		if (fullDay == null) {
	...
	public GoodsActualQuantityQuery goodsId(Long goodsId) {
		if (goodsId == null) {
	...
	public GoodsActualQuantityQuery goodsIds(List<Long> goodsIds) {
		if (goodsIds == null) {
	...
	public GoodsActualQuantityQuery goodsName(String goodsName) {
		if (goodsName == null) {
	...
	public GoodsActualQuantityQuery goodsNameLike(String goodsNameLike) {
	...
	public GoodsActualQuantityQuery goodsNodeId(Long goodsNodeId) {
		if (goodsNodeId == null) {
	...
	public GoodsActualQuantityQuery goodsNodeIds(List<Long> goodsNodeIds) {
	...
	public GoodsActualQuantityQuery ids(List<Long> ids) {
		if (ids == null) {
	...
	public GoodsActualQuantityQuery month(Integer month) {
		if (month == null) {
	...
	public GoodsActualQuantityQuery semester(Integer semester) {
		if (semester == null) {
	...
	public GoodsActualQuantityQuery tenantId(String tenantId) {
		if (tenantId == null) {
	...
	public GoodsActualQuantityQuery tenantIds(List<String> tenantIds) {
		if (tenantIds == null) {
	...
	public GoodsActualQuantityQuery unit(String unit) {
		if (unit == null) {
	...
	public GoodsActualQuantityQuery usageTimeGreaterThanOrEqual(Date usageTimeGreaterThanOrEqual) {
	...
	public GoodsActualQuantityQuery usageTimeLessThanOrEqual(Date usageTimeLessThanOrEqual) {
	...
	public GoodsActualQuantityQuery week(Integer week) {
		if (week == null) {
	...
	public GoodsActualQuantityQuery year(Integer year) {
		if (year == null) {
