...
@Entity
@Table(name = "HEALTH_FOOD_DRI_PERCENT")
public class FoodDRIPercent implements Serializable, JSONable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FoodDRIPercent other = (FoodDRIPercent) obj;
		if (id != other.id)
			return false;
		return true;
	}
	...
	public FoodDRIPercent jsonToObject(JSONObject jsonObject) {
		return FoodDRIPercentJsonFactory.jsonToObject(jsonObject);
	}
	...
	public JSONObject toJsonObject() {
		return FoodDRIPercentJsonFactory.toJsonObject(this);
	}

	public ObjectNode toObjectNode() {
		return FoodDRIPercentJsonFactory.toObjectNode(this);
	}
