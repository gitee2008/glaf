...
@Entity
@Table(name = "HEALTH_PERSON_PAYMENT")
public class PersonPayment implements Serializable, JSONable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PersonPayment other = (PersonPayment) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	public String getPayTimeString() {
		if (this.payTime != null) {
			return DateUtils.getDateTime(this.payTime);
		}
		return "";
	}
	...
	public PersonPayment jsonToObject(JSONObject jsonObject) {
		return PersonPaymentJsonFactory.jsonToObject(jsonObject);
	}
	...
	public JSONObject toJsonObject() {
		return PersonPaymentJsonFactory.toJsonObject(this);
	}

	public ObjectNode toObjectNode() {
		return PersonPaymentJsonFactory.toObjectNode(this);
	}
