...
public class SmsHistoryMessageQuery extends DataQuery {
	...
	public SmsHistoryMessageQuery() {

	}

	public SmsHistoryMessageQuery clientId(String clientId) {
		if (clientId == null) {
	...
	public SmsHistoryMessageQuery createTimeGreaterThanOrEqual(Date createTimeGreaterThanOrEqual) {
	...
	public SmsHistoryMessageQuery createTimeLessThanOrEqual(Date createTimeLessThanOrEqual) {
	...
	public SmsHistoryMessageQuery fullDay(Integer fullDay) {
		if (fullDay == null) {
	...
	public SmsHistoryMessageQuery mobile(String mobile) {
		if (mobile == null) {
	...
	public SmsHistoryMessageQuery mobileLike(String mobileLike) {
		if (mobileLike == null) {
			throw new RuntimeException("mobile is null");
		}
	...
	public SmsHistoryMessageQuery month(Integer month) {
		if (month == null) {
	...
	public SmsHistoryMessageQuery sendTimeGreaterThanOrEqual(Date sendTimeGreaterThanOrEqual) {
	...
	public SmsHistoryMessageQuery sendTimeLessThanOrEqual(Date sendTimeLessThanOrEqual) {
	...
	public SmsHistoryMessageQuery serverId(String serverId) {
		if (serverId == null) {
	...
	public SmsHistoryMessageQuery year(Integer year) {
		if (year == null) {
