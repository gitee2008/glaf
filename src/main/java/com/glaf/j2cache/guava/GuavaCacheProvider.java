...
public class GuavaCacheProvider implements CacheProvider {
	...
	protected static ConcurrentMap<String, GuavaCache> cacheConcurrentMap = new ConcurrentHashMap<String, GuavaCache>();
	...
	public Cache buildCache(String regionName, boolean autoCreate, CacheExpiredListener listener)
		...
		GuavaCache cache = cacheConcurrentMap.get(regionName);
		if (cache == null) {
