...
public class ChartServiceImpl implements IChartService {
	...
	public void save(Chart chart) {
		...
		if (chart.getQuerySQL() != null) {
			...
			sqlDefinition.setCode("chart_" + chart.getId());
			sqlDefinition.setName(chart.getChartName());
			sqlDefinition.setSql(chart.getQuerySQL());
			sqlDefinition.setTitle(chart.getSubject());
			sqlDefinition.setType("CHART");
