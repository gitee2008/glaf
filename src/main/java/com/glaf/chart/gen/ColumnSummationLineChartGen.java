...
public class ColumnSummationLineChartGen implements ChartGen {
	protected static final Log logger = LogFactory
			.getLog(ColumnSummationLineChartGen.class);

	public static void main(String[] paramArrayOfString) {
		ColumnSummationLineChartGen chartDemo = new ColumnSummationLineChartGen();
	...
	public JFreeChart createChart(Chart chartModel) {
		logger.debug("------------ColumnSummationLineChartGen.createChart-----------------");
