...
public class SystemParamController {
	protected static final Log logger = LogFactory
			.getLog(SystemParamController.class);

	protected ISystemParamService systemParamService;

	public SystemParamController() {
	...
	public ModelAndView edit(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/sys/param/edit", modelMap);
	}
	...
	public ModelAndView list(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/sys/param/list", modelMap);
	}
	...
	public ModelAndView query(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/sys/param/query", modelMap);
	}
	...
	public ModelAndView view(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/sys/param/view");
	}
