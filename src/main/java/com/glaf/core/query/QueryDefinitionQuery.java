...
public class QueryDefinitionQuery extends BaseQuery {
	...
	public QueryDefinitionQuery createTimeGreaterThanOrEqual(Date createTimeGreaterThanOrEqual) {
	...
	public QueryDefinitionQuery createTimeLessThanOrEqual(Date createTimeLessThanOrEqual) {
	...
	public QueryDefinitionQuery lockedGreaterThanOrEqual(Integer lockedGreaterThanOrEqual) {
	...
	public QueryDefinitionQuery lockedLessThanOrEqual(Integer lockedLessThanOrEqual) {
	...
	public QueryDefinitionQuery revisionGreaterThanOrEqual(Integer revisionGreaterThanOrEqual) {
	...
	public QueryDefinitionQuery revisionLessThanOrEqual(Integer revisionLessThanOrEqual) {
