...
public class ColumnDefinitionQuery extends BaseQuery {
	...
	public ColumnDefinitionQuery namedColumnSetIdLike(String namedColumnSetIdLike) {
	...
	public ColumnDefinitionQuery namedColumnSetIds(List<String> namedColumnSetIds) {
	...
	public ColumnDefinitionQuery tableId(String tableId) {
		if (tableId == null) {
