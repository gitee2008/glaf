...
public class SysDataQuery extends DataQuery {
	...
	public SysDataQuery createDateGreaterThanOrEqual(Date createDateGreaterThanOrEqual) {
	...
	public SysDataQuery updateDateGreaterThanOrEqual(Date updateDateGreaterThanOrEqual) {
