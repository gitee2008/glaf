 ...
 *
 */
public class AggregationDefinitionDomainFactory {

	public static final String TABLENAME = "SYS_AGGREGATION_DEF";
	...
	static {
		...
		columnMap.put("precision", "PRECISION_");
		columnMap.put("targetTableName", "TARGETTABLENAME_");
		columnMap.put("partitionFlag", "PARTITIONFLAG_");
		columnMap.put("resultFlag", "RESULTFLAG_");
		...
		javaTypeMap.put("precision", "Integer");
		javaTypeMap.put("targetTableName", "String");
		javaTypeMap.put("partitionFlag", "String");
		javaTypeMap.put("resultFlag", "String");
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("AggregationDefinition");
		...
		ColumnDefinition precision = new ColumnDefinition();
		precision.setName("precision");
		precision.setColumnName("PRECISION_");
		precision.setJavaType("Integer");
		tableDefinition.addColumn(precision);
		...
		ColumnDefinition partitionFlag = new ColumnDefinition();
		partitionFlag.setName("partitionFlag");
		partitionFlag.setColumnName("PARTITIONFLAG_");
		partitionFlag.setJavaType("String");
		partitionFlag.setLength(1);
		tableDefinition.addColumn(partitionFlag);

		ColumnDefinition resultFlag = new ColumnDefinition();
		resultFlag.setName("resultFlag");
		resultFlag.setColumnName("RESULTFLAG_");
		resultFlag.setJavaType("String");
		resultFlag.setLength(1);
		tableDefinition.addColumn(resultFlag);
	...
	private AggregationDefinitionDomainFactory() {
