...
public class BatchUpdateBean {
	 ...
	 * @param dataList
	 */
	public void dynamicUpdate(LoginContext loginContext, Connection conn, SysTable sysTable,
	 ...
	 * @param dataList
	 */
	public void executeBatch(LoginContext loginContext, Connection conn, SysTable sysTable,
			List<Map<String, Object>> dataList) {
		StringBuilder buffer = new StringBuilder();
		TableColumn idColumn = sysTable.getIdColumn();
		List<TableColumn> columns = sysTable.getColumns();
