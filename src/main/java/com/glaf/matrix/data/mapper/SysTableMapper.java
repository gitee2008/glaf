...
public interface SysTableMapper {
	...
	void deleteSysTableById(String tableId);

	void deleteSysTables(SysTableQuery query);

	SysTable getSysTableById(String tableId);

	SysTable getSysTableByTableName(String tableName);

	int getSysTableCount(SysTableQuery query);

	List<SysTable> getSysTables(SysTableQuery query);

	List<SysTable> getTableColumns(SysTableQuery query);

	void insertSysTable(SysTable model);

	void updateSysTable(SysTable model);
