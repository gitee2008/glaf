...
public interface TableCorrelationService {

	@Transactional
	void bulkInsert(List<TableCorrelation> list);
	 ...
	 * @return
	 */
	TableCorrelation getTableCorrelation(String id);
	 ...
	 */
	@Transactional
	void save(TableCorrelation tableCorrelation);
