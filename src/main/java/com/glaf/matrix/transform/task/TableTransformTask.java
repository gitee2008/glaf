...
import com.glaf.matrix.transform.bean.TableTransformBean;
...
public class TableTransformTask extends RecursiveTask<Boolean> {
	...
	public TableTransformTask(long databaseId, String transformId, String jobNo, Map<String, Object> parameter) {
	...
	public boolean execute() {
		...
		try {
			ExecutionHandlerFactory.doBefore("table_transform_" + transformId, context);
			...
			if (result) {
				...
				ExecutionHandlerFactory.doAfter("table_transform_" + transformId, context);
			}
		}
		...
		sysLog.setModuleId("table_transform_" + transformId);
		sysLog.setBusinessKey("table_transform_" + transformId);
