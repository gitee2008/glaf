 ...
 *
 */
public class CombinationHistoryJsonFactory {

	public static CombinationHistory jsonToObject(JSONObject jsonObject) {
		CombinationHistory model = new CombinationHistory();
	...
	public static JSONObject toJsonObject(CombinationHistory model) {
	...
	public static ObjectNode toObjectNode(CombinationHistory model) {
	...
	public static JSONArray listToArray(java.util.List<CombinationHistory> list) {
		JSONArray array = new JSONArray();
		if (list != null && !list.isEmpty()) {
			for (CombinationHistory model : list) {
	...
	public static java.util.List<CombinationHistory> arrayToList(JSONArray array) {
		java.util.List<CombinationHistory> list = new java.util.ArrayList<CombinationHistory>();
		for (int i = 0, len = array.size(); i < len; i++) {
			JSONObject jsonObject = array.getJSONObject(i);
			CombinationHistory model = jsonToObject(jsonObject);
			list.add(model);
		}
		return list;
	}

	private CombinationHistoryJsonFactory() {
