 ...
 *
 */
public class CombinationHistoryDomainFactory {

	public static final String TABLENAME = "SYS_COMBINATION_HISTORY";
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("CombinationHistory");
	...
	private CombinationHistoryDomainFactory() {
