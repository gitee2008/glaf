 ...
 *
 */
public class CategoryViewDomainFactory {

	public static final String TABLENAME = "SYS_CATEGORY_VIEW";
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("CategoryView");
	...
	private CategoryViewDomainFactory() {
