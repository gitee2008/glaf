 ...
 *
 */
public class CategoryAccessDomainFactory {

	public static final String TABLENAME = "SYS_CATEGORY_ACCESS";
	...
	static {
		...
		columnMap.put("categoryId", "PROJECTID_");
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("CategoryAccess");
		...
		categoryId.setColumnName("PROJECTID_");
	...
	private CategoryAccessDomainFactory() {
