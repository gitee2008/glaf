...
public class AlipayService {
	 ...
	 * @return 表单提交HTML文本
	 */
	public static String buildForm(String partner, String seller_email, String return_url, String notify_url,
			String show_url, String out_trade_no, String subject, String body, String total_fee, String paymethod,
			String defaultbank, String anti_phishing_key, String exter_invoke_ip, String extra_common_param,
			String buyer_email, String royalty_type, String royalty_parameters, String input_charset, String key,
			String sign_type, String it_b_pay) {
		...
		String mysign = AlipayFunction.buildSign(sParaNew, key);// 生成签名结果
