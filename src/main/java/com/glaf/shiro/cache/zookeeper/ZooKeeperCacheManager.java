...
public class ZooKeeperCacheManager implements CacheManager, Initializable, Destroyable {
	...
	private final static Logger log = LoggerFactory.getLogger(ZooKeeperCacheManager.class);
	...
	public <K, V> Cache<K, V> getCache(String key) throws CacheException {
		return new ZooKeeperCache<K, V>("/shiro_session");
	}

	public void init() throws ShiroException {
		log.info("-----------------------init zookeeper cache manager------------");
	}
