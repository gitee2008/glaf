...
public class TaskListenerTypes {
	...
	private static final Log logger = LogFactory.getLog(TaskListenerTypes.class);

	static Map<String, Class<?>> taskListeners = initializeTaskListenerTypes();

	private final static String DEFAULT_CONFIG = "com/glaf/flowable/tasklistener/factory/flowable.tasklistener.xml";
	...
	static Map<String, Class<?>> initializeTaskListenerTypes() {
		...
		String resource = SystemProperties.getString("flowable.taskListeners");
		...
		String ext_resource = CustomProperties.getString("flowable.taskListeners");
