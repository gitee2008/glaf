...
public class CancelTaskMultiInstanceListener implements TaskListener {
	...
	protected final static Log logger = LogFactory.getLog(CancelTaskMultiInstanceListener.class);
		...
		if (conditionExpression != null) {
			...
			if (value != null) {
				...
				if (value instanceof Boolean) {
					...
					if (b.booleanValue()) {
						if (delegateTask.getVariable(Constants.NUMBER_OF_COMPLETED_INSTANCES) != null) {
							int nrOfCompletedInstances = (Integer) delegateTask
									.getVariable(Constants.NUMBER_OF_COMPLETED_INSTANCES);
							delegateTask.setVariable(Constants.NUMBER_OF_COMPLETED_INSTANCES,
