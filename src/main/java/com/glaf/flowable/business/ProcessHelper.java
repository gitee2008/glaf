 ...
 */
package com.glaf.flowable.business;
...
public class ProcessHelper {
	...
	public void exportAll(RepositoryService repositoryService, String exportDir) {
		...
		if (list != null && !list.isEmpty()) {
			for (ProcessDefinition processDefinition : list) {
				try {
					this.exportDiagramToFile(repositoryService, processDefinition, exportDir);
				} catch (Exception ex) {
					ex.printStackTrace();
				}
			}
	...
	public void exportAll(String exportDir) {
		RepositoryService repositoryService = ContextFactory.getBean("repositoryService");
	 ...
	 * @return 文件的全路径
	 */
	public String exportDiagramToFile(RepositoryService repositoryService, ProcessDefinition processDefinition,
			String exportDir) {
