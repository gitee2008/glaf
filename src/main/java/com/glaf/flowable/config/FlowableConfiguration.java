...
package com.glaf.flowable.config;
...
/**
 * Adds flowable configuration files to a Configuration
 */
public class FlowableConfiguration extends Configuration {

	protected final static Log LOG = LogFactory
			.getLog(FlowableConfiguration.class);

	private FlowableConfiguration() {
		super();
		addCustomResources(this);
	}

	public static Configuration addCustomResources(Configuration conf) {
		conf.addResource("glaf-flowable-default.xml");
		conf.addResource("glaf-flowable-site.xml");
		return conf;
	}
	 ...
	 * @return a Configuration created with the glaf-flowable-*.xml files plus
