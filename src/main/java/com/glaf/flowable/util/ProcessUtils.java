...
public class ProcessUtils {
	...
	public static byte[] getImage(String processDefinitionId) {
		...
		if (processDefinition == null) {
			FlowableProcessQueryService flowableProcessQueryService = ContextFactory
					.getBean("flowableProcessQueryService");
		...
		if (processDefinition != null) {
			...
			if (resourceName != null) {
				...
				if (!fs.exists()) {
					try {
						FlowableDeployQueryService flowableDeployQueryService = ContextFactory
								.getBean("flowableDeployQueryService");
						InputStream inputStream = flowableDeployQueryService
								.getResourceAsStream(
