...
public class ReportJsonFactory {
	...
	public static Report jsonToObject(JSONObject jsonObject) {
		...
		if (jsonObject.containsKey("reportDateYYYYMMDD")) {
			model.setReportDateYYYYMMDD(jsonObject.getString("reportDateYYYYMMDD"));
		}
		...
		if (jsonObject.containsKey("postProcessor")) {
			model.setPostProcessor(jsonObject.getString("postProcessor"));
		}
	...
	public static JSONObject toJsonObject(Report model) {
		...
		if (model.getPostProcessor() != null) {
			jsonObject.put("postProcessor", model.getPostProcessor());
		}
