...
public class Report implements Serializable, JSONable {
	 ...
	 * 是否公开
	 */
	@Column(name = "PUBLICLAG_", length = 1)
	protected String publicFlag;

	/**
	 * 后置处理器
	 */
	@Column(name = "POSTPROCESSOR_", length = 500)
