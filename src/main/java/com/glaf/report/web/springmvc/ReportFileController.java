...
@Controller("/reportFile")
@RequestMapping("/reportFile")
public class ReportFileController {
	protected static final Log logger = LogFactory.getLog(ReportFileController.class);
	...
	public ModelAndView edit(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/reportFile/edit", modelMap);
	}
	...
	public ModelAndView list(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/reportFile/list", modelMap);
	}
	...
	public ModelAndView query(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/reportFile/query", modelMap);
	}
	...
	public ModelAndView view(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/reportFile/view");
	}
