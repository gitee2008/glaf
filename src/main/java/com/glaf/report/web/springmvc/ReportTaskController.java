...
public class ReportTaskController {
	protected static final Log logger = LogFactory.getLog(ReportTaskController.class);
	...
	public ModelAndView chooseReport(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/reportTask/chooseReport", modelMap);
	}
		...
		if (StringUtils.isNotEmpty(reportTaskIds)) {
			...
			while (token.hasMoreTokens()) {
				...
				if (StringUtils.isNotEmpty(x)) {
					...
					if (reportTask != null && StringUtils.equals(reportTask.getCreateBy(), loginContext.getActorId())) {
						reportTaskService.deleteById(reportTask.getId());
					}
				}
			}
		} else if (StringUtils.isNotEmpty(reportTaskId)) {
			ReportTask reportTask = reportTaskService.getReportTask(reportTaskId);
			if (reportTask != null && StringUtils.equals(reportTask.getCreateBy(), loginContext.getActorId())) {
				reportTaskService.deleteById(reportTask.getId());
			}
		}
	...
	public ModelAndView edit(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/reportTask/edit", modelMap);
	}
	...
	public ModelAndView list(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/reportTask/list", modelMap);
	}
	...
	public ModelAndView query(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/reportTask/query", modelMap);
	}
	...
	public ModelAndView view(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/reportTask/view");
	}
